...
export const customers=(params)=>api.get('/api/KhachHang/quan-ly',{params});
export const customerDetail=id=>api.get(`/api/KhachHang/quan-ly/${encodeURIComponent(id)}`);
export const staffAddDocument=(id,data)=>api.post(`/api/KhachHang/sale/${encodeURIComponent(id)}/giay-to`,data);
